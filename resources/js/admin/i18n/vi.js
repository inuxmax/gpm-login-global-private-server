export default {
    ...
    settings: {
        ...
        testS3Connection: 'Kiểm tra kết nối S3',
        s3TestSuccess: 'Kết nối S3 thành công ({duration} ms)',
        s3TestFailed: 'Kết nối S3 thất bại',
        s3TestMissingFields: 'Vui lòng nhập S3 Key, Secret và Bucket trước khi test',
